...
const double constants::V_F = 13709; // орбитальная скорость Юптера м/сек
const double constants::t10 = 3754; // суммарное время, нулевое приближение  (в сутках) 3650 - начальное
const double constants::A_0 = 0.0059361; //гравитационная постоянная*Mc/R0**2
const double constants::PU_0 = 652;    // сопряженная переменная
const double constants::PV_0 = 1482;    // сопряженная переменная
const double constants::PR_0 = -0.000351; // сопряженная переменная
